...
export const SETTINGS_INDEX: SearchIndexEntry[] = [
  ...
  { tab: 'integrations',   titleKey: 'musicNetwork.title',                keywords: 'last.fm lastfm libre.fm rocksky listenbrainz maloja scrobble scrobbling music network threshold percent force' },
  ...
  { tab: 'personalisation',titleKey: 'settings.playerBarTitle',          keywords: 'player bar playback favorites stars rating lastfm love scrobble force send equalizer mini player controls hide show' },
