export const deTranslation = {
  ...
  settings: {
    ...
    playerBarTitle: 'Playerleiste',
    playerBarReset: 'Zurücksetzen',
    playerBarDesc: 'Optionale Steuerelemente neben dem Cover und rechts in der Playerleiste ein- oder ausblenden. Die Lautstärke bleibt sichtbar, wenn Platz ist.',
    playerBarStarRating: 'Sternbewertung',
