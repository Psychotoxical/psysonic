export const deTranslation = {
  ...
  search: {
    ...
    shareTrackTitle: 'Geteilter Track',
    shareQueueTitle_one: 'Geteilte Warteschlange ({{count}} Track)',
    shareQueueTitle_other: 'Geteilte Warteschlange ({{count}} Tracks)',
    shareQueueAction: 'Zur Warteschlange hinzufügen',
    shareQueueing: 'Wird zur Warteschlange hinzugefügt…',
    shareQueued_one: '{{count}} geteilten Track zur Warteschlange hinzugefügt',
    shareQueued_other: '{{count}} geteilte Tracks zur Warteschlange hinzugefügt',
    shareQueuedPartial: '{{queued}} von {{total}} geteilten Tracks zur Warteschlange hinzugefügt ({{skipped}} nicht gefunden).',
    shareUnsupportedTitle: 'Dieser Freigabe-Link kann hier nicht eingereiht werden',
    shareUnsupportedSub: 'Nutze einen Track-, Album-, Künstler- oder Warteschlangen-Link.',
    title: 'Suche',
