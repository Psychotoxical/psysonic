export const frTranslation = {
  ...
  search: {
    ...
    shareTrackTitle: 'Morceau partagé',
    shareQueueTitle_one: 'File partagée ({{count}} morceau)',
    shareQueueTitle_other: 'File partagée ({{count}} morceaux)',
    shareQueueAction: 'Ajouter à la file',
    shareQueueing: 'Ajout à la file…',
    shareQueued_one: '{{count}} morceau partagé ajouté à la file',
    shareQueued_other: '{{count}} morceaux partagés ajoutés à la file',
    shareQueuedPartial: '{{queued}} sur {{total}} morceaux partagés ajoutés à la file ({{skipped}} introuvables).',
    shareUnsupportedTitle: 'Ce lien de partage ne peut pas être mis en file ici',
    shareUnsupportedSub: 'Utilisez un lien de morceau, album, artiste ou file.',
    title: 'Recherche',
