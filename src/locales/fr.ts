export const frTranslation = {
  ...
  settings: {
    ...
    playerBarTitle: 'Barre du lecteur',
    playerBarReset: 'Réinitialiser',
    playerBarDesc: 'Afficher ou masquer des contrôles optionnels à côté de la pochette et à droite de la barre de lecture. Le volume reste visible lorsqu\'il y a de la place.',
    playerBarStarRating: 'Note en étoiles',
    playerBarFavorite: 'Favori (cœur)',
    playerBarLastfmLove: 'Love Last.fm',
