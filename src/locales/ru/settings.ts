export const settings = {
  ...
  analyticsStrategyDesc: 'Выберите, когда Psysonic анализирует треки для waveform, громкости и обогащения BPM.',
  analyticsStrategyLabel: 'Стратегия',
  analyticsStrategyLazy: 'Ленивая',
  analyticsStrategyLazyDesc: 'Аналитика при проигрывании или попадании в горячий/офлайн-кэш — минимальная нагрузка на CPU и сеть.',
  analyticsStrategyAdvanced: 'Продвинутая',
  analyticsStrategyAdvancedDesc: 'Пока работает плеер, поддерживает очередь загрузки на уровне ~3× числа потоков, чтобы воркеры не простаивали. Воспроизведение всегда в приоритете.',
  ...
  analyticsStrategyPriorityLow: '3 — Библиотечный batch (только Продвинутая): автоматическая фоновая очередь в хвосте; пополняется по watermark (~3× потоков), не дожидаясь полного опустошения.',
  ...
  analyticsStrategyAdvancedWarning: 'Больше нагрузка на CPU и сеть, пока идёт фоновый прогон библиотеки.',
