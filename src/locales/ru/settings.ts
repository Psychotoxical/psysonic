export const settings = {
  ...
  streamQualityTitle: 'Качество стриминга',
  streamQualityPerAddressDesc: 'Просить Navidrome транскодировать поток до предела битрейта — полезно на медленных или удалённых соединениях. Настраивается для каждого адреса: LAN-адрес и публичный прокси могут иметь разные пределы; воспроизведение использует настройку подключённого адреса. Влияет только на стриминг — офлайн- и кэшированные треки всегда играют в исходном качестве.',
  streamQualityOriginal: 'Без ограничения битрейта',
  streamQualityKbps: '{{kbps}} кбит/с',
  streamFormatLabel: 'Формат транскодирования',
  ...
  pauseResumeFade: 'Затухание при паузе и возобновлении',
  pauseResumeFadeDesc: 'Плавно приглушает звук при паузе и возвращает громкость при возобновлении.',
  pauseResumeFadeDuration: 'Длительность затухания',
  ...
  showCardTooltips: 'Полное название при наведении',
  showCardTooltipsSub: 'Показывать полное название альбома и исполнителя, когда карточка их обрезает',
