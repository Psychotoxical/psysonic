export const settings = {
  ...
  hiResCrossfadeResampleTitle: 'Частота сведения Crossfade / AutoDJ',
  hiResCrossfadeResampleDesc: 'Когда соседние треки имеют разную частоту дискретизации, обе стороны передискретизируются на эту частоту во время кроссфейда и переходов AutoDJ.',
