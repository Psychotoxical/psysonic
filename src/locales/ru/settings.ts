export const settings = {
  ...
  playbackRateStrategyPreserve: 'Сдвиг pitch',
  playbackRateSpeed: 'Скорость',
  playbackRatePitch: 'Pitch',
  playbackRateDerivedPitch: 'Сдвиг pitch от скорости: {{value}}',
  playbackRateAutoPitch: 'Pitch корректируется автоматически.',
