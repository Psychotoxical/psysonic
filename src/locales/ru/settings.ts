export const settings = {
  ...
  cacheMaxLabel: 'Лимит',
  coverCacheTitle: 'Дисковый кэш обложек',
  coverCacheUsed: 'На диске: {{size}}',
  coverCachePressurePaused: 'Фоновая загрузка приостановлена (диск почти заполнен)',
  coverCacheMaxLabel: 'Лимит кэша обложек',
  coverCacheClearBtn: 'Очистить дисковый кэш обложек',
