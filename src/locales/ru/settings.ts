export const settings = {
  ...
  smartCrossfade: 'Умный кроссфейд',
  smartCrossfadeDesc: 'Без фиксированной длительности — переход подстраивается под само звучание, накладываясь на реальные затухания и вступления, а не на заданное число секунд. Для надёжной работы включите «Горячий кэш воспроизведения».',
