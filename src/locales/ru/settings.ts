export const settings = {
  ...
  queueTrackListCoversSub: 'Миниатюра альбома напротив каждого трека в панели очереди, мини-плеере и «Далее» в полноэкранном режиме. При отсутствии обложки запускается backfill библиотеки (при агрессивном кэшировании).',
  trackListCoverArtOnPages: 'Обложки в списках треков',
  trackListCoverArtOnPagesSub: 'Миниатюра альбома в списках Tracks, Search, плейлистов, избранного, Random Mix и других browse-списках. При отсутствии обложки запускается backfill библиотеки (при агрессивном кэшировании).',
