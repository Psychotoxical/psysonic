export const settings = {
  ...
  coverCacheStrategyDesc: 'Дисковый WebP-кэш обложек для каждого сервера (отдельно от офлайн-аудио). Без лимита размера — очистка по библиотеке.',
  ...
  coverCacheStrategyLazyDesc: 'Обложки для видимых страниц, очереди и по запросу.',
  coverCacheStrategyAggressive: 'Агрессивный',
  coverCacheStrategyAggressiveDesc: 'Как ленивый плюс фоновый проход по всему локальному каталогу (canonical 800px WebP).',
