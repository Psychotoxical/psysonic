export const esTranslation = {
  ...
  settings: {
    ...
    playerBarTitle: 'Barra del reproductor',
    playerBarReset: 'Restablecer a predeterminado',
    playerBarDesc: 'Muestra u oculta controles opcionales junto a la portada y a la derecha de la barra. El volumen sigue visible cuando hay espacio.',
    playerBarStarRating: 'Valoración por estrellas',
    playerBarFavorite: 'Favorito (corazón)',
    playerBarLastfmLove: 'Favorito en Last.fm',
