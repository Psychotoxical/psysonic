export const esTranslation = {
  ...
  search: {
    ...
    shareTrackTitle: 'Canción compartida',
    shareQueueTitle_one: 'Cola compartida ({{count}} canción)',
    shareQueueTitle_other: 'Cola compartida ({{count}} canciones)',
    shareQueueAction: 'Agregar a la cola',
    shareQueueing: 'Agregando a la cola…',
    shareQueued_one: '{{count}} canción compartida añadida a la cola',
    shareQueued_other: '{{count}} canciones compartidas añadidas a la cola',
    shareQueuedPartial: '{{queued}} de {{total}} canciones compartidas añadidas a la cola ({{skipped}} no encontradas).',
    shareUnsupportedTitle: 'Este enlace compartido no se puede agregar aquí',
    shareUnsupportedSub: 'Usa un enlace de canción, álbum, artista o cola.',
    title: 'Buscar',
