export const settings = {
  ...
  playbackRateHint: '« Velocidad » mantiene el tono natural. Varispeed cambia el pitch con la velocidad. « Tono » añade un desplazamiento manual. Usa más CPU que varispeed. No para radio, vistas previas u Orbit.',
  playbackRateNeutral: 'A 1,0× y sin desplazamiento de pitch, la reproducción es normal.',
