export const settings = {
  ...
  playbackRateHint: '« Hastighet » beholder naturlig tonehøyde. Varispeed endrer pitch med hastigheten. « Tonehøyde » legger til manuell offset. Mer CPU enn varispeed. Ikke for radio, forhåndsvisninger eller Orbit.',
  playbackRateNeutral: 'Ved 1,0× og uten pitch-offset er avspilling normal.',
