export const settings = {
  ...
  hiResCrossfadeResampleTitle: 'Crossfade / AutoDJ blandingsrate',
  hiResCrossfadeResampleDesc: 'Når nabospor har ulik samplingsrate, resamples begge sider til denne raten under crossfade og AutoDJ-overganger.',
