export const zhTranslation = {
  ...
  search: {
    ...
    shareLink: '分享链接',
    shareTrackTitle: '分享的歌曲',
    shareQueueTitle_one: '分享的队列（{{count}} 首）',
    shareQueueTitle_other: '分享的队列（{{count}} 首）',
    shareQueueAction: '加入队列',
    shareQueueing: '正在加入队列…',
    shareQueued_one: '已将 {{count}} 首分享歌曲加入队列',
    shareQueued_other: '已将 {{count}} 首分享歌曲加入队列',
    shareQueuedPartial: '已将 {{total}} 首中的 {{queued}} 首分享歌曲加入队列（{{skipped}} 首未找到）。',
    shareUnsupportedTitle: '此分享链接不能在这里加入队列',
    shareUnsupportedSub: '请使用歌曲、专辑、艺术家或队列分享链接。',
    title: '搜索',
