export const settings = {
  ...
  aboutContributorsApp: 'Aplicație',
  aboutContributorsThemes: 'Teme',
  aboutThemeContributorsCount_one: '{{count}} temă',
  aboutThemeContributorsCount_other: '{{count}} teme',
  ...
  pauseResumeFade: 'Estompare la pauză și reluare',
  pauseResumeFadeDesc: 'Reduce treptat sunetul la pauză și îl readuce la reluare.',
  pauseResumeFadeDuration: 'Durata estompării',
  ...
  showAlbumTooltips: 'Titlu complet la survolare',
  showAlbumTooltipsSub: 'Arată titlul complet al albumului și artistul când cardul le trunchiază',
