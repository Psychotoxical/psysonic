export const settings = {
  ...
  playbackRateHint: '« Viteză » păstrează tonul natural. Varispeed schimbă pitch-ul odată cu viteza. « Ton » adaugă un offset manual. Consumă mai mult CPU decât varispeed. Nu pentru radio, previzualizări sau Orbit.',
  playbackRateNeutral: 'La 1,0× și fără offset pitch, redarea este normală.',
