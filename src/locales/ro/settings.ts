export const settings = {
  ...
  smartCrossfade: 'Estompare inteligentă',
  smartCrossfadeDesc: 'Fără durată fixă — estomparea urmează sunetul real și se suprapune peste estompările și introducerile reale, în loc de un număr fix de secunde. Pentru rezultate fiabile, activează Cache-ul hot playback.',
