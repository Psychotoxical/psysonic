export const nbTranslation = {
  ...
  search: {
    ...
    shareTrackTitle: 'Delt sang',
    shareQueueTitle_one: 'Delt kø ({{count}} sang)',
    shareQueueTitle_other: 'Delt kø ({{count}} sanger)',
    shareQueueAction: 'Legg til i kø',
    shareQueueing: 'Legger til i kø…',
    shareQueued_one: '{{count}} delt sang lagt til i køen',
    shareQueued_other: '{{count}} delte sanger lagt til i køen',
    shareQueuedPartial: '{{queued}} av {{total}} delte sanger lagt til i køen ({{skipped}} ikke funnet).',
    shareUnsupportedTitle: 'Denne delingslenken kan ikke legges i kø her',
    shareUnsupportedSub: 'Bruk en sang-, album-, artist- eller kølenke.',
    title: 'Søk',
