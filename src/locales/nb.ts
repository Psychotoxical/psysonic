export const nbTranslation = {
  ...
  settings: {
    ...
    playerBarTitle: 'Avspillingslinje',
    playerBarReset: 'Tilbakestill til standard',
    playerBarDesc: 'Vis eller skjul valgfrie knapper ved omslaget og til høyre på avspillingslinjen. Volum vises når det er plass.',
