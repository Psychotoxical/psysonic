export const settings = {
  ...
  libraryIndexDesc: 'Hält eine lokale Kopie der Track-Datenbank dieses Servers vor, damit Stöbern und Suche schnell bleiben und offline funktionieren. Synchronisiert im Hintergrund; bei großen Bibliotheken kann der erste Durchlauf dauern.',
  libraryIndexEnable: 'Lokalen Bibliotheksindex aktivieren',
  libraryIndexEnableDesc: 'Startet eine Hintergrund-Synchronisation für den aktiven Server.',
  libraryIndexNoServer: 'Zuerst einen Server verbinden.',
