export const settings = {
  ...
  pauseResumeFade: '暂停和恢复时淡入淡出',
  pauseResumeFadeDesc: '暂停时淡出音频，恢复时再淡入。',
  pauseResumeFadeDuration: '淡入淡出时长',
  ...
  showAlbumTooltips: '悬停显示完整标题',
  showAlbumTooltipsSub: '当卡片截断时显示完整的专辑标题和艺术家',
