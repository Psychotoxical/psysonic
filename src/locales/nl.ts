export const nlTranslation = {
  ...
  search: {
    ...
    shareLink: 'Deellink',
    shareTrackTitle: 'Gedeeld nummer',
    shareQueueTitle_one: 'Gedeelde wachtrij ({{count}} nummer)',
    shareQueueTitle_other: 'Gedeelde wachtrij ({{count}} nummers)',
    shareQueueAction: 'Aan wachtrij toevoegen',
    shareQueueing: 'Toevoegen aan wachtrij…',
    shareQueued_one: '{{count}} gedeeld nummer toegevoegd aan de wachtrij',
    shareQueued_other: '{{count}} gedeelde nummers toegevoegd aan de wachtrij',
    shareQueuedPartial: '{{queued}} van {{total}} gedeelde nummers toegevoegd aan de wachtrij ({{skipped}} niet gevonden).',
    shareUnsupportedTitle: 'Deze deellink kan hier niet in de wachtrij',
    shareUnsupportedSub: 'Gebruik een nummer-, album-, artiest- of wachtrijlink.',
    title: 'Zoeken',
