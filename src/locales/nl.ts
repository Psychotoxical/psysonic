export const nlTranslation = {
  ...
  settings: {
    ...
    playerBarTitle: 'Spelerbalk',
    playerBarReset: 'Standaard herstellen',
    playerBarDesc: 'Optionele knoppen naast de hoes en rechts op de spelerbalk tonen of verbergen. Volume blijft zichtbaar wanneer er ruimte is.',
    playerBarStarRating: 'Sterrenbeoordeling',
    playerBarFavorite: 'Favoriet (hart)',
    playerBarLastfmLove: 'Last.fm love',
    playerBarEqualizer: 'Equalizer',
    playerBarMiniPlayer: 'Miniplayer',
