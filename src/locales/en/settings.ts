export const settings = {
  ...
  smartCrossfade: 'Smart crossfade',
  smartCrossfadeDesc: 'No fixed duration — the overlap follows the actual audio, blending real fade-outs and intros instead of a set number of seconds. For reliable results, enable the Hot playback cache.',
