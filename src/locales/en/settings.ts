export const settings = {
  ...
  coverCacheTitle: 'Cover art disk cache',
  coverCacheUsed: 'On disk: {{size}}',
  coverCachePressurePaused: 'Background warm-up paused (disk nearly full)',
  coverCacheMaxLabel: 'Cover cache max',
  coverCacheClearBtn: 'Clear cover disk cache',
