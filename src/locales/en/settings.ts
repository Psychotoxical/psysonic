export const settings = {
  ...
  coverCacheStrategyDesc: 'Per-server WebP cover cache on disk (separate from offline audio). No size limit — clear per library when needed.',
  ...
  coverCacheStrategyLazyDesc: 'Download covers for visible pages, queue, and on-demand views only.',
  coverCacheStrategyAggressive: 'Aggressive',
  coverCacheStrategyAggressiveDesc: 'Lazy behaviour plus a background pass over the full local catalog (canonical 800px WebP).',
