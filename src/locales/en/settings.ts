export const settings = {
  ...
  libraryIndexDesc: 'Keep a local copy of this server\'s track database so browsing and search stay fast and work offline. Syncs in the background; large libraries can take a while on first run.',
  libraryIndexEnable: 'Enable local library index',
  libraryIndexEnableDesc: 'Starts a background sync for the active server.',
  libraryIndexNoServer: 'Connect a server first.',
