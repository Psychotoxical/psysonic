export const settings = {
  ...
  queueTrackListCoversSub: 'Show a small album cover beside each track in the queue panel, mini player queue, and fullscreen Up next. Missing covers trigger library backfill when aggressive caching is enabled.',
  trackListCoverArtOnPages: 'Album art in track lists',
  trackListCoverArtOnPagesSub: 'Show a small album cover beside tracks on Tracks, Search, playlists, favorites, Random Mix, and other browse lists. Missing covers trigger library backfill when aggressive caching is enabled.',
