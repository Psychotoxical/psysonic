export const settings = {
  ...
  heroButtonSizeLabel: 'Button size',
  heroButtonSizeDesc: 'Size of the action buttons in album, artist and playlist headers.',
  heroButtonSize_large: 'Large',
  heroButtonSize_small: 'Small',
