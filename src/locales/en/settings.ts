export const settings = {
  ...
  hiResCrossfadeResampleTitle: 'Crossfade / AutoDJ blend rate',
  hiResCrossfadeResampleDesc: 'When adjacent tracks have different sample rates, both sides are resampled to this rate during crossfade and AutoDJ transitions.',
