export const settings = {
  ...
  analyticsStrategyDesc: 'Choose when Psysonic analyzes tracks for waveforms, loudness, and BPM enrichment.',
  analyticsStrategyLabel: 'Strategy',
  analyticsStrategyLazy: 'Lazy',
  analyticsStrategyLazyDesc: 'Analyze tracks when they play or enter the hot/offline cache — minimal CPU and network use.',
  analyticsStrategyAdvanced: 'Advanced',
  analyticsStrategyAdvancedDesc: 'While the player is running, keeps the analysis download queue filled to ~3× worker count so parallel threads stay busy. Playback always stays ahead.',
  ...
  analyticsStrategyPriorityLow: '3 — Library batch (Advanced only): automatic background queue at the tail; refilled by watermark (~3× workers) without waiting for an empty queue.',
  ...
  analyticsStrategyAdvancedWarning: 'Uses more CPU and network bandwidth while the library batch runs in the background.',
