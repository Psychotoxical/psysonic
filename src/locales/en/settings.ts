export const settings = {
  ...
  streamQualityDesc: 'Ask the server to transcode the live stream down to a bitrate cap to save bandwidth. Only affects streaming — offline and cached tracks always play at their original quality.',
  streamQualityLabel: 'Maximum stream bitrate',
  streamQualityFieldDesc: 'Sent to the server as a transcode ceiling. Tracks already at or below this bitrate stream untouched. Your server must have transcoding enabled for this to take effect.',
  streamQualityOriginal: 'Original (no transcode)',
