export const settings = {
  ...
  aboutContributorsApp: 'Application',
  aboutContributorsThemes: 'Thèmes',
  aboutThemeContributorsCount_one: '{{count}} thème',
  aboutThemeContributorsCount_other: '{{count}} thèmes',
  ...
  pauseResumeFade: 'Fondu à la pause et à la reprise',
  pauseResumeFadeDesc: 'Atténue le son à la pause et le rétablit à la reprise.',
  pauseResumeFadeDuration: 'Durée du fondu',
  ...
  showAlbumTooltips: 'Titre complet au survol',
  showAlbumTooltipsSub: 'Afficher le titre complet de l\'album et l\'artiste lorsque la carte les tronque',
