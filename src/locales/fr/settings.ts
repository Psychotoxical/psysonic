export const settings = {
  ...
  queueTrackListCoversSub: 'Show a small album cover beside each track in the queue panel, mini player queue, and fullscreen Up next.',
  trackListCoverArtOnPages: 'Album art in track lists',
  trackListCoverArtOnPagesSub: 'Show a small album cover beside tracks on Tracks, Search, playlists, favorites, and other browse lists.',
