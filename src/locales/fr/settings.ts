export const settings = {
  ...
  playbackRateHint: '« Vitesse » conserve la hauteur naturelle. Varispeed change le pitch avec la vitesse. « Hauteur » ajoute un décalage manuel. Plus gourmand en CPU que varispeed. Non pour la radio, les aperçus ou Orbit.',
  playbackRateNeutral: 'À 1,0× sans décalage de pitch, la lecture est normale.',
