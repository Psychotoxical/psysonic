export const settings = {
  ...
  playbackRateHint: '« Snelheid » behoudt de natuurlijke toonhoogte. Varispeed verandert pitch met de snelheid. « Toonhoogte » voegt een handmatige offset toe. Meer CPU dan varispeed. Niet voor radio, previews of Orbit.',
  playbackRateNeutral: 'Bij 1,0× en zonder pitch-offset is afspelen normaal.',
