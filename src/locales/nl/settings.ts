export const settings = {
  ...
  aboutContributorsThemes: "Thema's",
  aboutThemeContributorsCount_one: '{{count}} thema',
  aboutThemeContributorsCount_other: "{{count}} thema's",
  ...
  pauseResumeFade: 'Fade bij pauzeren en hervatten',
  pauseResumeFadeDesc: 'Laat audio uitfaden bij pauzeren en weer infaden bij hervatten.',
  pauseResumeFadeDuration: 'Fadeduur',
  ...
  showCardTooltips: 'Volledige titel bij zweven',
  showCardTooltipsSub: 'Toon de volledige albumtitel en artiest wanneer de kaart ze afkapt',
