...
export const ruTranslation = {
  ...
  search: {
    ...
    shareQueued_one: '{{count}} общий трек добавлен в очередь',
    shareQueued_few: '{{count}} общих трека добавлены в очередь',
    shareQueued_many: '{{count}} общих треков добавлены в очередь',
    shareQueued_other: '{{count}} общего трека добавлено в очередь',
    shareQueuedPartial: '{{queued}} из {{total}} общих треков добавлены в очередь ({{skipped}} не найдены).',
    shareUnsupportedTitle: 'Эту ссылку нельзя добавить в очередь здесь',
    shareUnsupportedSub: 'Используйте ссылку на трек, альбом, исполнителя или очередь.',
    title: 'Поиск',
