...
export const ruTranslation = {
  ...
  settings: {
    ...
    loudnessPreAnalysisAttenuationDesc:
      'Насколько приглушить звук, пока для трека нет сохранённого измерения громкости. При стриме дальше идут лишь грубые оценки, не полный LUFS. 0 dB — без дополнительного приглушения; ниже — тише. Ползунок — значение в опоре −14 LUFS; справа — фактическая поправка для текущей цели.',
    loudnessPreAnalysisAttenuationRef: 'Ползунок {{ref}} dB (опора −14 LUFS) → фактически {{eff}} dB при цели {{tgt}} LUFS.',
