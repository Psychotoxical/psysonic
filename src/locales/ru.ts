...
export const ruTranslation = {
  ...
  settings: {
    ...
    playerBarDesc: 'Показывать или скрывать дополнительные элементы у обложки и справа на панели плеера. Громкость остаётся, когда хватает места.',
    playerBarStarRating: 'Оценка звёздами',
    playerBarFavorite: 'Избранное (сердце)',
    playerBarLastfmLove: 'Love на Last.fm',
