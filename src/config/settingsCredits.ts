...
const CONTRIBUTOR_ENTRIES = [
  ...
  },
  {
    ...
    contributions: [
      ...
      'Playback — ReplayGain index prefetch, gapless playbar sync, library replayGainPeak column, live RG refresh after sync (report: Asra on Psysonic Discord) (PR #1231)',
    ],
  },
  {
    github: 'kilyabin',
