...
const CONTRIBUTOR_ENTRIES = [
  ...
  },
  {
    ...
    contributions: [
      ...
      'Smart Playlist editor: themed sort dropdown, stable mode toggles, include/exclude genre colors, exclude-all → untagged tracks (report: zunoz on Psysonic Discord) (PR #970)',
    ],
  },
  {
    github: 'kilyabin',
