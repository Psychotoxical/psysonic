...
const CONTRIBUTOR_ENTRIES = [
  ...
  },
  {
    ...
    contributions: [
      ...
      'Offline experience — unified media layout (cache/library/favorites), localPlaybackStore, library-index Offline Library, favorites auto-sync, mixed-server offline queue, and single mediaDir setting (PR #1008)',
    ],
  },
  {
    github: 'kilyabin',
