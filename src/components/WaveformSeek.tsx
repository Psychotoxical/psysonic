...
import {
  ...
  Particle, SEG_COUNT, STATIC_REDRAW_FORCE_MS, STATIC_REDRAW_MIN_MS, SeekbarColors,
  WAVE_BIN_COUNT, WAVE_MIX_MAX, WAVE_MIX_MEAN, WAVE_MORPH_MS,
  binsToHeights, easeOutCubic, fmt, getColors, heightsNearlyEqual,
  invalidateColorCache, isBarQuantizedSeekStyle, makeAnimState, makeFlatWaveHeights,
  makeHeights, quantizeProgressByBars, setShadowBlur, setupCanvas, waveformBarThickness,
