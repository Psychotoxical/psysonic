...
* **Cached playlists stay in sync** — a manually offline-pinned playlist re-downloads added tracks and removes dropped ones when the server track list changes (edits, smart-playlist refresh, reconnect).
